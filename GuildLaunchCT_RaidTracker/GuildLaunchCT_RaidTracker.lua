CT_RaidTrackerAddEventFrameTemplate = {
...
CT_RaidTrackerNextBossFrameTemplate = {
    bgFile = "Interface\\DialogFrame\\UI-DialogBox-Background",
    edgeFile = "Interface\\DialogFrame\\UI-DialogBox-Border",
    tile = true,
    tileEdge = true,
...
CT_RaidTrackerAcceptWipeFrameTemplate = {
    bgFile = "Interface\\DialogFrame\\UI-DialogBox-Background",
    edgeFile = "Interface\\DialogFrame\\UI-DialogBox-Border",
    tile = true,
    tileEdge = true,
...
CT_RaidTrackerJoinLeaveFrameTemplate = {
    bgFile = "Interface\\DialogFrame\\UI-DialogBox-Background",
    edgeFile = "Interface\\DialogFrame\\UI-DialogBox-Border",
    tile = true,
    tileEdge = true,
...
CT_RaidTrackerEditNoteFrameTemplate = {
    bgFile = "Interface\\DialogFrame\\UI-DialogBox-Background",
    edgeFile = "Interface\\DialogFrame\\UI-DialogBox-Border",
    tile = true,
    tileEdge = true,
...
CT_RaidTrackerAcceptDeleteFrameTemplate = {
    bgFile = "Interface\\DialogFrame\\UI-DialogBox-Background",
    edgeFile = "Interface\\DialogFrame\\UI-DialogBox-Border",
    tile = true,
    tileEdge = true,
...
CT_RaidTrackerPlayerLineTemplateTemplate = {
    bgFile = "Interface\\DialogFrame\\UI-DialogBox-Background",
    edgeFile = "Interface\\DialogFrame\\UI-DialogBox-Border",
    tile = true,
    tileEdge = true,
...
UIPanelWindows["CT_RaidTrackerFrame"] = {
    area = "left",
    pushable = 1,
    whileDead = 1
};
...
--	end
    ...
    elseif ( event == "VARIABLES_LOADED" ) then
        --CT_RaidTrackerFrame:CreateTitleRegion() These are depricated from 7.0+ but also don't seem to break anything when turned off. Will keep an eye out
...
function CT_RaidTracker_DoZoneCheck()
    ...
    if(newzone == "Ny'alotha, the Waking City") then
        CT_RaidTracker_AwaitingNZoth = newzone;
    end
    local subzone = GetSubZoneText();
    if(CT_RaidTracker_AwaitingNZoth == "Ny'alotha, the Waking City" and subzone == "Chamber of Heart") then
        CT_RaidTracker_BossKill("", "", "", "", "", "", "", "", "N'Zoth") --trigger nzoth kill
    end
